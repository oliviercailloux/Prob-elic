...
\begin{theorem}[FKG binary]
 ...
 \begin{proof}
 	...
 	\end{align}
 	We need to show that $\Omega ≥ 0$. Let’s recur on the length of $T$. The singleton lattice has length $0$, assume $T$ has length at least $1$, thus, at least one atom $a$.
