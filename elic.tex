...
The possible sets of edges are all $E$ that are transitive and acyclic. \ommentMP{Il faut décider si on travaille avec des relations réflexives ou irréflexives; distinguer aussi les graphes orientés des non-orientés; adopter une terminologie non-ambigüe)}
