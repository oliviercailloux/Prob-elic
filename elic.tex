...
\begin{figure}
	\begin{tikzpicture}
		...
		\path (abc-db-node.south) ++(7mm, -1cm) coordinate (abc-db-eb);
		
		\path (abc-db-node.south) ++(-7mm, -1cm) coordinate (abc-db-be);

		\path (abc-db-node.south)  edge node[left] {$b > e$} (abc-db-be);
		\path (abc-db-node.south) edge node[right] {$e > b$} (abc-db-eb);	
