...
\begin{itemize}
	...
	\item $E^s[\card{{\ppref}_3} - \card{{\ppref}_1} \knowing {\ppref}_1 = ab, q_2 = \bm{q_{cd}}] = 1$. \commentOC{Think again!}
...
\end{itemize}
\commentOC{Draw the optimal strategies in two trees.}
...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\path [draw] (ab-a) -- (ab-b);
		\path  node [fit={(ab-a) (ab-b)}, inner sep=0] (ab) {};
		
		\path (ab-b.south) ++(-1cm, -1cm) node[anchor=north] (abc-a) {$a$};
		...
		\path  node [fit={(abc-a) (abc-b) (abc-c)}, inner sep=0] (abc) {};

		\path (ab-b.south) ++(1cm, -1cm) node[anchor=north] (ab-cb-a) {$a$};
		...
		\path  node [fit={(ab-cb-a) (ab-cb-b) (ab-cb-c)}, inner sep=0] (ab-cb) {};

		\path [draw] (ab.south) -- (abc.north);
		\path [draw] (ab.south) -- (ab-cb.north);

		\path (abc-c.south) ++(-1cm, -1cm) node[anchor=north] (abcd-a) {$a$};
		\path (abcd-a.south) ++(0, -\ordown) node[anchor=north] (abcd-b) {$b$};
		\path (abcd-b.south) ++(0, -\ordown) node[anchor=north] (abcd-c) {$c$};
		\path (abcd-c.south) ++(0, -\ordown) node[anchor=north] (abcd-d) {$d$};
		\path [draw] (abcd-a) -- (abcd-b) -- (abcd-c) -- (abcd-d);

		\path (abc-c.south) ++(1cm, -1cm) node[anchor=north] (abc-bd-a) {$a$};
		\path (abc-bd-a.south) ++(3mm, -\ordown) node[anchor=north] (abc-bd-b) {$b$};
		\path (abc-bd-b.south) ++(0, -\ordown) node[anchor=north] (abc-bd-c) {$c$};
		\path (abc-bd-a.south) ++(6mm, 0) node[anchor=south] (abc-bd-d) {$d$};
		\path [draw] (abc-bd-a) -- (abc-bd-b) -- (abc-bd-c);
		\path [draw] (abc-bd-d) -- (abc-bd-b);
	\end{tikzpicture}
	\caption{The strategy for three questions}
	\label{fig:k3}
\end{figure}
