...
Given a partial order $\ppref$, we write $P(\ppref) = P(\set{{\pref} \suchthat {\ppref} \subseteq {\pref}})$ for the probability that the real preference is compatible with $\ppref$.
