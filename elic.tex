...
Let $P(>, (E_t)_{t \in \inQ}) = P(>, (q_t)_{t \in \intvl{1, \card{Q}}} \suchthat E_t = E_{t - 1} + q_t)$ denote the probability that the preference is $>$ and that the questions asked lead to the sequence of graphs $(E_t)$.
