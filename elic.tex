...
\begin{conjecture}
	...
	Assume that $\alpha ≤ \gamma$ and $\alpha' ≤ \gamma'$ and assume that $\zeta(\ppref, b) > \zeta(\ppref', b')$.
...
\begin{conjecture}
	...
	for any $z \in X$ isolated in $\ppref$ and in $\ppref'$,
...
\begin{proof}
	...
	We know that $s ≥ s' ≥ d' ≥ d$ and $(s > s' \lor d' > d)$.
