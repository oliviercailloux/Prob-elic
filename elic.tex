...
\begin{proof}
	...
	Letting again $R(\gamma)$ denote $\sum_{0 ≤ k ≤ \gamma - 1} \binom{\alpha + \delta + \gamma - k}{\delta + \gamma - k}$, we obtain from the previous proof:
	\begin{align}
		P[z < b \knowing {\ppref}] 
		& = \frac{1}{\alpha + \gamma + \delta + 2} 
		\frac{
		...
		& = \frac{1}{\alpha + \gamma + \delta + 2} 
		\frac{
			\binom{\alpha + \gamma + \delta + 2}{\delta + 1} - R(\gamma + 1)
		}{
			\binom{\alpha + \gamma + \delta + 1}{\delta + 1} - R(\gamma)
		}\\
		& = \frac{1}{\alpha + \gamma + \delta + 2} 
		\frac{
			\frac{\alpha + \gamma + \delta + 2}{\alpha + \gamma + 1} \binom{\alpha + \gamma + \delta + 1}{\delta + 1} - R(\gamma + 1)
		}{
			\binom{\alpha + \gamma + \delta + 1}{\delta + 1} - R(\gamma)
		}\\
		& = \frac{1}{\alpha + \gamma + 1} 
		\frac{
			\binom{\alpha + \gamma + \delta + 1}{\delta + 1} - \frac{\alpha + \gamma + 1}{\alpha + \gamma + \delta + 2} R(\gamma + 1)
		}{
			\binom{\alpha + \gamma + \delta + 1}{\delta + 1} - R(\gamma)
		}.
	\end{align}
