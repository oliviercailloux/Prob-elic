...
\end{lemma}
\begin{proof}
$P(\ppref) = P(\{\ppref^{\prime\prime} \in \linors[X]: \ppref^{\prime\prime} \supseteq \ppref\})$. We have that 
$$
\{\ppref^{\prime\prime} \in \linors[X]: \ppref^{\prime\prime} \supseteq \ppref\} = \bigcup_{\ppref' \in \linors[X']: \ppref' \supseteq \ppref} \{\ppref^{\prime\prime} \in \linors[X]: \ppref^{\prime\prime}_{|X'} = \ppref'\}.
$$   
The latter union is disjoint. Therefore, 
$$
\{\ppref^{\prime\prime} \in \linors[X]: \ppref^{\prime\prime} \supseteq \ppref\}= \sum_{\ppref' \in \linors[X']: \ppref' \supseteq \ppref} P(\ppref').
$$
...
\begin{proof} Another proof. I replace $a$ by $d$ in the Proposition. We try to assess $P(d > b \knowing {\ppref})$. We have that $X'= A \cup \{b\} \cup C$, where $A=\ {\ppref}(b)$, $C=\ {\ppref^{-1}}(b)$ and $\ppref_{|A} = \emptyset =\ \ppref_{|C}$. Let $X^{\prime\prime} = X' \cup \{d\}$.
By Lemma \ref{le:probaPartialOrder}, we have :
$$
P(\ppref) = \frac{|\{\ppref' \in \linors[X']: \ppref' \supseteq \ppref\}|}{|X'|!} = \frac{|A|! \cdot |C|!}{(|A|+|C|+1)!}
$$
and, by applying Lemma \ref{le:probaPartialOrder} to $X^{\prime\prime}$, 
$$
