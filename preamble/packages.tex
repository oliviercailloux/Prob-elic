...
%For \psCalculate{3.14126*314^2}, which uses \num from siunitx.
...
%Also loaded by tikz.
	\usepackage{xcolor}
	\usepackage{tikz}
	\usetikzlibrary{babel, matrix, fit, plotmarks, calc, trees, shapes.geometric, positioning, plothandlers, arrows, shapes.multipart, graphs}
